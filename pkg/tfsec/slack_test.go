...
func TestGetTfSecSlack(t *testing.T) {
	testCases := []struct {
		...
		{"adddme", "1", "https://github.com/bradmccoydev/tfval", "mock.json", "{\"results\": [{\"rule_id\": \"azure-database-enable-audit\",\"legacy_rule_id\": \"AZU018\",\"rule_description\": \"Auditing should be enabled on Azure SQL Databases\",\"rule_provider\": \"azure\",\"impact\": \"Auditing provides valuable information about access and usage\",\"resolution\": \"Enable auditing on Azure SQL databases\",\"links\": [\"https://tfsec.dev/docs/azure/database/enable-audit#azure/database\",\"https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/sql_server#extended_auditing_policy\",\"https://docs.microsoft.com/en-us/azure/azure-sql/database/auditing-overview\"],\"description\": \"Resource 'azurerm_mssql_server.default' does not have an extended audit policy configured.\",\"severity\": \"MEDIUM\",\"status\": \"failed\",\"location\": {\"filename\": \"/opt/atlassian/pipelines/agent/build/azurerm/azurerm_mssql_server/main.tf\",\"start_line\": 1,\"end_line\": 11}}]}", nil},
	}
